function coordinate_max_min=save_latex_figure(filename)
% this code is useful for obtaining a .PNG figure from a matlab figure
if nargin<1
    filename='latex_figure';
end
coordinate_max_min=axis;
